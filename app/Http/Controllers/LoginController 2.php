...
class LoginController extends Controller
{
    ...
    public function Signup(Request $request)
    {
        ...
        Log::info(print_r($request->all(), true));
        $urltoken = $request->urltoken;
        $tmp_password = $request->tmp_password;

        Log::info(print_r('urltoken:'.$urltoken, true));
        Log::info(print_r('tmp_password:'.$tmp_password, true));
        $sql = "select
            TM.id as torihikisaki_id,
            convert( AES_DECRYPT( UNHEX(TM.torihikisaki_nm), '".$password."' ) USING utf8) as torihikisaki_nm,
        ...
        if (count($user) === 0){
            ...
            if ($tmp_password == $user[0]->torihikisaki_web_password) {
                $torihikisaki_id = $user[0]->torihikisaki_id;
                $torihikisaki_nm = $user[0]->torihikisaki_nm;
                $torihikisaki_tantosya_email = $user[0]->torihikisaki_tantosya_email;
                $kaisya_nm = $user[0]->kaisya_nm;
    ...
    public function TmpRegister(Request $request)
    {
        ...
        $host = config('app.url');
        $inputEmail = $request->inputEmail;
        if($inputEmail == "tugi@tugilo.com" || $inputEmail == "tugi.max@gmail.com"|| $inputEmail == "tugi@shoan.co.jp" || $inputEmail == "bugtest@bughaus.jp" || $inputEmail == "mitunami@gmail.com" || $inputEmail == "nakajima@cues-plus.com" || $inputEmail == "fujita.yoshio@gmail.com")
        {
            $mailto = $inputEmail;
...
//            Log::info(print_r("SQL:".$sql, true));
            ...
            Log::info(print_r("tmp_passwd:".$tmp_passwd, true));
            Log::info(print_r("urltoken:".$urltoken, true));
            ...
            if(empty($org_tmp_passwd) || empty($org_urltoken))
            {
                ...
                $update_sql = DB::update($empty_sql);
...
//                Log::info(print_r($shisyalists, true));
    ...
    public function ConfirmRegister(Request $request)
    {
        ...
        if($inputChangeBranch == 1)
        {
            ...
            $printChangeBranch = "2022年5月";
        }else if($inputChangeBranch == 3){
            $printChangeBranch = "2022年6月";
        }else if($inputChangeBranch == 4){
            $printChangeBranch = "2022年7月";
        }else if($inputChangeBranch == 5){
            $printChangeBranch = "2022年8月";
        }else if($inputChangeBranch == 6){
            $printChangeBranch = "2022年9月";
        }else if($inputChangeBranch == 7){
            $printChangeBranch = "2022年10月";
        }else if($inputChangeBranch == 8){
            $printChangeBranch = "2022年11月";
        }else if($inputChangeBranch == 9){
            $printChangeBranch = "2022年12月";
        }else if($inputChangeBranch == 10){
            $printChangeBranch = "2023年1月";
        }else if($inputChangeBranch == 11){
            $printChangeBranch = "2023年2月";
        }else if($inputChangeBranch == 12){
            $printChangeBranch = "2023年3月";
        }else if($inputChangeBranch == 13){
            $printChangeBranch = "2023年4月";
        }else{
            $printChangeBranch = "";
        }
    ...
    public function Register(Request $request)
    {
        ...
        if($changeBranchRadios == 1)
        {
            if($inputChangeBranch == 1)
            {
                ...
                $dataChangeBranch = "2022-05-01";
            }else if($inputChangeBranch == 3){
                $dataChangeBranch = "2022-06-01";
            }else if($inputChangeBranch == 4){
                $dataChangeBranch = "2022-07-01";
            }else if($inputChangeBranch == 5){
                $dataChangeBranch = "2022-08-01";
            }else if($inputChangeBranch == 6){
                $dataChangeBranch = "2022-09-01";
            }else if($inputChangeBranch == 7){
                $dataChangeBranch = "2022-10-01";
            }else if($inputChangeBranch == 8){
                $dataChangeBranch = "2022-11-01";
            }else if($inputChangeBranch == 9){
                $dataChangeBranch = "2022-12-01";
            }else if($inputChangeBranch == 10){
                $dataChangeBranch = "2023-01-01";
            }else if($inputChangeBranch == 11){
                $dataChangeBranch = "2023-02-01";
            }else if($inputChangeBranch == 12){
                $dataChangeBranch = "2023-03-01";
            }else if($inputChangeBranch == 13){
                $dataChangeBranch = "2023-04-01";
            }else{
