      ...
      <section class="content-box mt-0">
        ...
        <div class="container">
          ...
          <dl class="mb-5">
            ...
            <dd class="ml-4">
              <h4 class="h3">振替申込締切（未申込みの方のみ）<br>10月5日（木）まで</h4>
          ...
          <dl class="mb-5">
            ...
            <dd class="ml-4">
              <h4 class="h3">ラベル提出期間<br><span class="text-red">【厳守】</span>10月27日（金）～11月3日（金・祝）まで</h4>
          ...
          <dl class="mb-5">
            ...
            <dd class="ml-4">
              <h4 class="h3">同封物（私製あいさつ状、会社パンフ等）関連資材<br><span class="text-red">【厳守】</span>11月17日（金）まで</h4>
