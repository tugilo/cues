  ...
  <div class="main-content-body">
    <div class="container">
      ...
      <section class="interview-box px-0">
        <a href="/calendar/interview/detail?vol=10_01" class="interview-header">
          <div class="row row-cols-1 row-cols-lg-2 no-gutters">
            <div class="col">
              <div class="card h-100 border-0">
                <img class="img-fluid" src="/images/interview/vol10_mainimg.jpg" alt="Special interview">
              </div>
            </div>
            <div class="col">
              <div class="card h-100 border-0">
                <div class="card-body catchcopy">
                  <img class="img-fluid" src="/images/interview/vol10_catchcopy.png" alt="Special interview">
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row no-gutters">
                ...
                <div class="col-7">
                  <div class="card-body">
                    ...
                    <p class="card-text">お客さんとの距離感を縮めていく。僕らライフプランナーにとって、やはりこれが一番大事じゃないかと思っています。</p>
                  </div>
                </div>
              </div>
            </a>
              ...
              <div class="row no-gutters">
                ...
                <div class="col-7">
                  <div class="card-body">
                    ...
                    <p class="card-text">
                        保全活動らしいことはあまりできていないと思います。
                        だから、せめて年賀状とカレンダーだけは送らないと、という感じです。
                    </p>
                  </div>
                </div>
              </div>
