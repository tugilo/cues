      ...
      <section class="content-box">
        ...
        <div class="image-text-wrapper">
          <div class="image-container">
              <img class="img-fluid" src="/images/greeting/aisatu_subtittle01.jpg" alt="アンケート">
          </div>
      </div>
      <div class="text-container">
        <span class="text-red">【仕様を変更しました】</span>
    </div>
 <p class="small">【表面】本年より、アンケートはがきの仕様変更を行っています。
          昨年まで各支社様管理職(支社長、営業所長)様のご協力をいただき、宛名面は管理職様のお名前が記されておりましたが、本年販売分より、過去よりご希望が強かった
          <span class="tet-red">「発注者様のみ」のお名前表記となっております。</span>
          ぜひ、より以上にご活用ください。
        </p>
        <p class="small">【裏面】保全活動として有効なお客様アンケート。内容はLPの皆様がご理解（ご利用）され、汎用性がある表現を使用しています。</p>
      </div>
      <div class="section">
