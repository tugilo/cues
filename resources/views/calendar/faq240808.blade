...
<article class="main-content border-top">
  ...
  <div class="breadcrumbs">
    <div class="container">
      <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="ホーム" href="/calendar" class="home"><i class="fas fa-home"></i><span property="name">ホーム</span></a><meta property="position" content="1"></span> <i class="fas fa-angle-right"></i> <span property="itemListElement" typeof="ListItem"><span property="name" class="post post-post current-item">よくある質問</span><meta property="url" content="./index.html"><meta property="position" content="2"></span>
    </div> <!-- .container -->
  </div>
        ...
        <div class="accordion faq" id="accordionFaq200">
          ...
          <div class="card">
            ...
            <div id="collapseFaq205" class="collapse" aria-labelledby="headingFaq205" data-parent="#accordionFaq200">
              <div class="card-body">
                <p>
                    販売時期により、ご注文いただけない商品があり、二次/三次販売の際は価格も変更となりますので、一次販売時期でのご注文をお薦めいたします（詳しくは<a href="/calendar/schedule">「こちらの表」</a>をご確認ください）。
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="accordion faq" id="accordionFaq400">
          ...
          <div class="card">
            ...
            <div id="collapseFaq402" class="collapse" aria-labelledby="headingFaq402" data-parent="#accordionFaq400">
              <div class="card-body">
                <p>前述の対象者の方のみ、マイページ画面に、ダウンロードボタンが表示されます。そちらからご利用ください。</p>
              </div>
            </div>
          </div>
          <div class="card">
        ...
        <div class="accordion faq" id="accordionFaq500">
          ...
          <div class="card">
            ...
            <div id="collapseFaq504" class="collapse" aria-labelledby="headingFaq504" data-parent="#accordionFaq500">
              <div class="card-body">
                <p>カレンダーへの同封物は、個別に弊社事務所に11月17日（金）まで必着(到着厳守)でお送りください。また同封物の封入順、方法等の指示がない場合は当方任意の作業とさせていただいております。</p>
              </div>
            </div>
          </div>
          <div class="card">
          ...
          <div class="card">
            ...
            <div id="collapseFaq510" class="collapse" aria-labelledby="headingFaq510" data-parent="#accordionFaq500">
              <div class="card-body">
                <p>おおよそ支社様毎に11月30日（水）～12月9日（土）の期間内で順次投函となります。</p>
              </div>
            </div>
          </div>
          <div class="card">
        ...
        <div class="accordion faq" id="accordionFaq600">
          <div class="card">
            ...
            <div id="collapseFaq601" class="collapse" aria-labelledby="headingFaq401" data-parent="#accordionFaq600">
              <div class="card-body">
                <p>発送代行ご希望の方には、「発送代行依頼書兼宛名ラベル回収封筒」と「宛名ラベル印刷虎の巻」を弊社からお届けし、ラベル提出期間を10月27日（金）～11月3日（金）弊社到着【期間厳守】としております。提出方法などにつきましては、支社様単位で個別にメール等で事前案内をさせていただきます。</p>
        ...
        <div class="accordion faq" id="accordionFaq900">
          ...
          <div class="card">
            ...
            <div id="collapseFaq905" class="collapse" aria-labelledby="headingFaq905" data-parent="#accordionFaq900">
              <div class="card-body">
                <p>口座変更をご希望の方は、預金口座振替依頼書を改めてお送りいたしますので、10月5日（木）迄にご返送ください。</p>
              </div>
            </div>
          </div>
          <div class="card">
