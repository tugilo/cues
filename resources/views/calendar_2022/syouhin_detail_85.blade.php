            ...
            <div class="row my-lg-4 py-lg-4">
              ...
              <div class="col-lg-6 mb-4">
                <div class="item-image text-center">
                  <div class="border-0">
                    <img src="/images/takuC_01_SOLD.jpg" class="card-img-top" alt="卓上カレンダー（ハガキサイズ）">
                  </div>
                </div>
              </div>
              <div class="col-lg-6 mb-4">
                  ...
                  <form method="post" action="/calendar/cart/add" name="form1" id="form1">
                    ...
                    <div class="form-group row pb-0">
                      ...
                      <div class="col-6 col-lg-7">
                          <input type="number" class="form-control amount_field" id="syohin_cd_85" name="syohin_amount[]" value="" placeholder="0" disabled>
                    ...
                    <div class="form-group row pb-0">
                      ...
                      <div class="col-6 col-lg-7">
                          <input type="number" class="form-control amount_field" id="syohin_cd_86" name="syohin_amount[]" value="" placeholder="0" disabled>
      ...
      <section class="content-box">
        ...
        <div class="row align-items-center">
          <div class="col-12 col-lg-6 my-3">
            <img class="img-fluid" src="/images/takuC_img01.jpg" alt="2023 年カレンダーイメージ">
          </div>
          <div class="col-12 col-lg-6 my-3">
            <img class="img-fluid" src="/images/takuC_img02.jpg" alt="2023 年カレンダーイメージ">
          </div>
        </div>
