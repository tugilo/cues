  ...
  <div class="main-content-body">
    <div class="container">
      ...
      <section class="content-box">
        ...
        <p>LP様の作業負担はラベルご用意のみとなり、年末多忙な皆様の「時間」を確保することが可能です。<br><span class="text-red">※挨拶状／アンケート付きカレンダー以外をご注文の場合は、「差出人ラベル」が必要です。</span></p>
        ...
        <div class="bg-headline">
          <h3 class="h5 p-2">宛名ラベルを、締切日までに ご準備ください <br class="d-block d-lg-none"><span class="small">（メール便より品質が高いとされる郵便「ゆうめーる」での発送です）</span></h3>
        </div>
        <div class="row">
