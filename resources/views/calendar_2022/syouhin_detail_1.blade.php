                  ...
                  <form method="post" action="/calendar/cart/add">
                    ...
                    <div class="form-group row pb-0">
                      ...
                      <div class="col-6 col-lg-7">
                        <input type="number" class="form-control amount_field" id="syohin-cd_1" name="syohin_amount[]" value="" placeholder="0" disabled>
                    ...
                    <div class="form-group row pb-0">
                      ...
                      <div class="col-6 col-lg-7">
                          <input type="number" class="form-control amount_field" id="syohin-cd_2" name="syohin_amount[]" value="" placeholder="0" disabled>
