            ...
            <div class="row my-lg-4 py-lg-4">
              ...
              <div class="col-lg-6 mb-4">
                <div class="item-image text-center">
                  <div class="border-0">
                    <img src="/images/kabeC_01_SOLD.jpg" class="card-img-top" alt="壁壁掛けカレンダー（A4 特寸サイズ）">
                  </div>
                </div>
              </div>
              <div class="col-lg-6 mb-4">
                  ...
                  <form method="post" action="/calendar/cart/add">
                    ...
                    <div class="form-group row pb-0">
                      ...
                      <div class="col-6 col-lg-7">
                          <input type="number" class="form-control amount_field" id="syohin-cd_92" name="syohin_amount[]" value="" placeholder="0" disabled>
                    ...
                    <div class="form-group row pb-0">
                      ...
                      <div class="col-6 col-lg-7">
                          <input type="number" class="form-control amount_field" id="syohin-cd_93" name="syohin_amount[]" value="" placeholder="0" disabled>
