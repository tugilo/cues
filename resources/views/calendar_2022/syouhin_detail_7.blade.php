                  ...
                  <form method="post" action="/calendar/cart/add">
                    ...
                    <div class="form-group row pb-0">
                      ...
                      <div class="col-6 col-lg-7">
                          <input type="number" class="form-control amount_field" id="syohin-cd_7" name="syohin_amount[]" value="" placeholder="0" disabled>
                    ...
                    <div class="form-group row pb-0">
                      ...
                      <div class="col-6 col-lg-7">
                          <input type="number" class="form-control amount_field" id="syohin-cd_8" name="syohin_amount[]" value="" placeholder="0" disabled>
      ...
      <section class="content-box">
        ...
        <div class="row align-items-center">
          <div class="col-12 col-lg-5 my-3">
            <img class="img-fluid" src="/images/takuA_img01.jpg" alt="2023 年カレンダーイメージ">
          </div>
          <div class="col-12 col-lg-7 my-3">
            <img class="img-fluid" src="/images/takuA_img02.jpg" alt="2023 年カレンダーイメージ">
          </div>
        </div>
