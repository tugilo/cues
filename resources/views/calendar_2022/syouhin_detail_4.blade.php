  ...
  <div class="main-content-body">
    <div class="container">
                  ...
                  <form method="post" action="/calendar/cart/add">
                    ...
                    <div class="form-group row pb-0">
                      ...
                      <div class="col-6 col-lg-7">
                          <input type="number" class="form-control amount_field" id="syohin-cd_4" name="syohin_amount[]" value="" placeholder="0" disabled>
                    ...
                    <div class="form-group row pb-0">
                      ...
                      <div class="col-6 col-lg-7">
                          <input type="number" class="form-control amount_field" id="syohin-cd_5" name="syohin_amount[]" value="" placeholder="0" disabled>
      ...
      <section class="content-box">
        ...
        <div class="row mb-5">
          <div class="col-lg-8 offset-lg-2 border-top border-bottom pt-4 pb-3">
            <h3>差出人ラベル作成について</h3>
            <p class="small">差出人ラベルも、送付先ラベルと同様に作成ください。</p>
            <p class="small">ラベルにスタンパーを押していただいたものを、ご用意いただいても貼付可能ですが、<br>ラベルからはみ出ないようにスタンプを押してください。</p>
          </div>
        </div>
      ...
      <section class="content-box">
        ...
        <h2 class="h1 text-center text-dark-blue mt-5 pt-5">＜2023 年カレンダー掲載予定画像＞</h2>

        <div class="row">
          <div class="col-lg-10 offset-lg-1">
            <p class="small">POJ様のお仕事でも大活躍中の八雲いつか氏がアメリカ主要都市を撮影。</p>
            <p class="small">画像を主体に、「高品質」なデザインで仕上げました。例年大好評の氏の作品に、ご期待ください。</p>
            <p class="small">※本作に付きましては新型コロナの影響により取材が制限された為、氏のライブラリより制作　を行っております。</p>
          </div>
        </div>

        <div class="row align-items-center">
          <div class="col-12 col-lg-7 my-3">
            <img class="img-fluid" src="/images/kabeA_img03.jpg" alt="2023 年カレンダー掲載予定画像">
          </div>
          <div class="col-12 col-lg-5 my-3">
            <img class="img-fluid" src="/images/kabeA_img04.jpg" alt="2023 年カレンダー掲載予定画像">
          </div>
        </div>
